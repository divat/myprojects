...
<br/><br/>
<div class="form">
<form:form class="form-horizontal" id="add-manuscripts" action="addManuscripts" method="post" modelAttribute="manuscripts">   
<h5 style="text-align: center;font-weight: 500;color: #c70d0d;">${responseMsg}</h5>
	<div class="col-lg-12">
		<ol class="breadcrumb">
			<li><i class="fa fa-home"></i><a href="home">Home</a></li>
			<li><i class="fa fa-file-text-o"></i>Add Manuscripts</li>
				...
				<div class="col-lg-6">
					<section class="panel">
						...
						<div class="panel-body">
								...
								<div class="form-group">
									<label class="control-label col-sm-4">No. Of Manuscripts<span class="required">*</span></label>
										<div class="col-sm-6">
											<input id="manuscripts" name="manuscripts" type="text" value="" size="16" class="form-control">
										</div>
                                </div>
